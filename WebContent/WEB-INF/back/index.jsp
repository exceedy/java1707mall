...
<%@include file="../common/use.jsp" %>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="${path}/thirds/hAdmin/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="${path}/thirds/hAdmin/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="${path}/thirds/hAdmin/css/animate.css" rel="stylesheet">
    <link href="${path}/thirds/hAdmin/css/style.css?v=4.1.0" rel="stylesheet">
</head>
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${path}/product/pageList.action">商品展示</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${path}/product/toAddProduct.action">添加商品</a>
                            </li>
                        </ul>
                    </li>
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${path}/category/findAllCategory.action">分类展示</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${path}/category/toAddCategory.action">添加分类</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${path}/orderBack/toOrder.action">订单展示</a>
                            </li>
                            <%-- <li>
                                <a class="J_menuItem" href="${path}/category/toAddCategory.action">添加分类</a>
                            </li> --%>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                               <li class="active">
		                    <a href="${path}/campaign/searchConditionSelect.action" class="J_menuItem">广告列表</a>
		                </li>
		                <li  >
		                	<a href="${path}/campaign/toAddCampaign.action" class="J_menuItem">添加广告</a>
		                </li>
                        </ul>
                    </li>
                    <li class="line dk"></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="${path}/product/pageList.action?v=4.0" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
    ...
    <!-- 全局js -->
    <script src="${path}/thirds/hAdmin/js/jquery.min.js?v=2.1.4"></script>
    <script src="${path}/thirds/hAdmin/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="${path}/thirds/hAdmin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="${path}/thirds/hAdmin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="${path}/thirds/hAdmin/js/plugins/layer/layer.min.js"></script>

    <!-- 自定义js -->
    <script src="${path}/thirds/hAdmin/js/hAdmin.js?v=4.1.0"></script>
    <script type="text/javascript" src="${path}/thirds/hAdmin/js/index.js"></script>

    <!-- 第三方插件 -->
    <script src="${path}/thirds/hAdmin/js/plugins/pace/pace.min.js"></script>
