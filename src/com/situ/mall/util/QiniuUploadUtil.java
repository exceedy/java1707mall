...
public class QiniuUploadUtil {
	//服务器地址
	public static final String SERVER_ADDRES = "http://owyy75gow.bkt.clouddn.com/";
	
	/** 基本配置 */
	// 设置好账号的ACCESS_KEY和SECRET_KEY
	private static final String ACCESS_KEY = "Gf8VDzxv-Fmb5e0CEJARMewG4B-jsuYV7DtWFf-d";
	private static final String SECRET_KEY = "FMllgfFzsZgjkzMm9f9Wt90HeIJbTIEJB6Tdedlm";
	// 要上传的空间--目前用的测试空间--上线要修改
	private static final String BUCKET_NAME = "java";
