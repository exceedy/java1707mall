...
public class Category {
		...
		public Category(Integer id, Integer parentId, String name, Integer status, Integer sortOrder, Date updateTime) {
			super();
			this.id = id;
			this.parentId = parentId;
			this.name = name;
		...
		public Category(Integer parentId, String name, Integer status, Integer sortOrder, Date createTime) {
			super();
			this.parentId = parentId;
			this.name = name;
			this.status = status;
